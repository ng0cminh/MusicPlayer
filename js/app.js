...
const timeCurrent = $('#progress-time .current-time');
const timeTotal = $('#progress-time .total-time');
...
const app = {
    ...
    handlerEvents() {
        ...
        audio.ontimeupdate = function() {
            ...
            let timeMinut = Math.floor(audio.currentTime/60);
            let timeSecond = Math.floor(audio.currentTime%60);
            timeSecond < 10 ? timeSecond = `0${timeSecond}`: timeSecond;
            timeCurrent.innerText = `${timeMinut}:${timeSecond}`;
